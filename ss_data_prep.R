...
# ---- 4: Filter Study Area & Remove Houses, Roads, & Waterbodies ----
  ...
  plot(roads_buffered[10])
  
  # OPTIONAL: Read in written roads_buffered.shp
  ...
  # Clip to Study Area
  PTS_Study = st_intersection(PTS_Study, counties)
