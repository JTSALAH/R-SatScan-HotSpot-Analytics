...
# ---- 1: Prepare Data ----
  ...
  hs_full = st_read(here::here('SS_Runs', 'Yearly', 'ss_1234rm_FULL_r125m', 
                               'ss_layers', 'shapeclust.shp'))
...
# ---- 4: Remove Developed Land Class HotSpots ----
  ...
  rm_developed <- function(df) {
    ...
    # Filter CLUSTERs where the total proportion is 0.7 or more
  ...
  st_write(hs_full_filt,
    here::here('SS_Runs', 'Yearly', 'ss_1234rm_FULL_r125m', 
